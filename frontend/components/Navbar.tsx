  ...
  return (
    <header className="sticky top-0 z-50">
      <nav className="mx-auto bg-[#faf9f6]/10 backdrop-blur-xl shadow-sm">
        <div className="mx-auto flex h-16 max-w-6xl items-center justify-between px-6">
          <Link href="/home" className="flex items-center">
            <div>
              <p className="text-xl font-normal tracking-tight text-[#333333] font-serif">
                SC<span className="text-[#B45A2B]">M</span>
              </p>
            </div>
          </Link>
          ...
          >
            <svg
              ...
              className={`w-7 h-7 overflow-visible [transition:transform_.35s_ease] ${
                open ? "rotate-45" : ""
              }`}
            >
              <path
        ...
        <div
          className={`lg:hidden overflow-hidden border-t border-gray-200 transition-all duration-500 ease-in-out ${
            open
