      ...
      <div className="w-full">
        ...
        <div className="relative">
          ...
          <input
            ...
            disabled={disabled}
            className={`
              w-full rounded-xl border border-[#dfe3e8] bg-white px-4 py-3 text-sm text-gray-700 placeholder:text-gray-400 outline-none transition focus:border-[#bc5828] focus:ring-4 focus:ring-[#bc5828]/10
